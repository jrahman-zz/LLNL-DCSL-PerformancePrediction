...
def run_and_initialize_qos(qosAppName, qosAppDataPath, driverName, driverWorkload, qos_cores):
	"""
...
def run_experiment(params, output_path, rep):
    ...
    dataStoreFileForQoS = output_path + ".data"
    ...
    qos_pid = run_and_initialize_qos(qosApp, dataStoreFileForQoS, qosApp_cores)
