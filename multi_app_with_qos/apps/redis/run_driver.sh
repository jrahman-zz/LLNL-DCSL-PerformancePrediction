...
/usr/apps/python2.7.10/bin/python ${YCSB_DIR}/bin/ycsb run redis -s -target 55000 -threads 8 -P "${YCSB_DIR}/workloads/${WORKLOAD}" -p recordcount=300000 -p operationcount=15000000 -p "redis.host=127.0.0.1" -p "redis.port=6379" 2>&1 | egrep "${PATTERN}" > ${ABS_OUTPUT_PATH}
