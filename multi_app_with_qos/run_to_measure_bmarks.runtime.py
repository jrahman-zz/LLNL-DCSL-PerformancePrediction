...
def run_mpstat(outfile_name, mpstat_period):
    mpstat_core = 14
    #cmd = ['taskset', '-c', str(mpstat_core), 'mpstat', '-P', 'ALL', str(mpstat_period), '>', outfile_name]
    ...
    cmd = 'taskset -c ' + str(mpstat_core) + ' mpstat -P 0,1,2,3,4,5,6 ' +  str(mpstat_period) + ' > ' + outfile_name
